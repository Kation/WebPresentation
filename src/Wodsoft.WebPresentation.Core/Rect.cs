...
namespace Wodsoft.Web
{
    ...
    public partial struct Rect : IFormattable
    {
                    ...
                    double height)
        {
            if (width < 0 || height < 0)
            {
                throw new System.ArgumentException("Width and height can`t be negative.");
            }
        ...
        public Point Location
        {
            ...
            set
            {
                if (IsEmpty)
                {
                    throw new System.InvalidOperationException("Can`t modify empty Rect.");
                }
        ...
        public double Width
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new System.ArgumentException("Width can`t be negative.");
                }
        ...
        public double Height
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new System.ArgumentException("Height can`t be negative.");
                }
        ...
        public void Offset(Vector offsetVector)
        {
            if (IsEmpty)
            {
                throw new System.InvalidOperationException("Empty rect can`t call Offset method.");
            }
        ...
        public void Inflate(double width, double height)
        {
            if (IsEmpty)
            {
                throw new System.InvalidOperationException("Empty rect can`t call Inflate method.");
            }
